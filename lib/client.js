...
function Client(host, port) {
  ...
  this.on_handlers = {
    ...
    profile_unprofile_all: function(obj) {},
    profile_activate: function(obj) {},
    profile_setup: function(obj) {},
    profile_return: function(obj) {},
    disconnect: function() {}
  }
...
Client.prototype.socket_data_handler = function(data) {
  // TODO: Port this to Buffer.from(...) later
  var source = new Buffer(data);
...
Client.prototype.setup_read = function(length, fn) {
  // TODO: Port this to Buffer.alloc(...) later
 ...
 * Profiling *
 *************/
 Client.prototype.profile_toggle_function_handler = function(sexp) {
   // Extract the response
   console.log(sexp);
   this.on_handlers.profile_toggle_function({});
 }
